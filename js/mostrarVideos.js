...
async function listaVideos(){
    ...
    listaApi.forEach(element => lista.append(constroiCard(element.titulo, element.descricao, element.url, element.imagem)));//criando o card para cada elemento dentro da lista
}
